...
echo "  2. Run: openclaw models auth login --provider openai-codex --set-default"
echo "  3. Copy the printed authorization URL into a local browser."
echo "  4. After sign-in, paste the full redirect URL back into the CLI prompt."
echo ""
